...
import { ITEM_COLORS, FREEZE_DURATION, REVERSE_DURATION, GROW_AMOUNT, ITEM_COOLDOWN, SPEED_BOOST_DURATION } from './constants';
export class GameManager {
    roomGames = new Map();
    onGameUpdate;
    onGameEnded;
    constructor(onGameUpdate, onGameEnded) {
     ...
     * 使用道具
     */
    useItem(player, itemId, targetPlayerId, room) {
