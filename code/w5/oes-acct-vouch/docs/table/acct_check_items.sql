...
/****** 对象:  Table [dbo].[acct_check_items]    脚本日期: 2026/5/17 15:45:26 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[acct_check_items](
 ...
 CONSTRAINT [PK_acct_bank] PRIMARY KEY CLUSTERED 
(
	[acct_check_id] ASC
...
ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ((0)) FOR [line]
GO

ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ('') FOR [summary]
GO

ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ((0)) FOR [amt_debit]
GO

ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ((0)) FOR [amt_credit]
GO

ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ((0)) FOR [exch_rate]
GO

ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ((0)) FOR [amt_debit_f]
GO

ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ((0)) FOR [amt_credit_f]
GO

ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ('0') FOR [is_init]
GO

ALTER TABLE [dbo].[acct_check_items] ADD  DEFAULT ('0') FOR [open_state]
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'acct_check_items', @level2type=N'COLUMN',@level2name=N'UNIT_ID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'acct_check_items', @level2type=N'COLUMN',@level2name=N'UNIT_NUM'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'acct_check_items', @level2type=N'COLUMN',@level2name=N'UNIT_PRICE'
GO
